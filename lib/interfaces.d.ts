...
export declare type parseCallbackType = (data: object, isWs: boolean) => Promise<void>;
...
export declare type jobsCallbackType = (params: IJobsParams) => Promise<void>;
...
export declare type TAsyncFunction<A, O> = (...args: A[]) => Promise<O>;
export {};
