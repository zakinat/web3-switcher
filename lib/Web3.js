...
class Web3 extends NodeUrl_1.NodeUrl {
    ...
    handleReconnect() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.hasHttp = this.getUrlProvider().includes(NodeUrl_1.providerProtocol.https);
            if (!this.hasHttp) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const subscribRes = this.contracts[address].events.allEvents({ fromBlock, })
                    ...
                    .on('connected', (str) => console.log(`subscribeAllEvents successfully in the Contract ${address} 
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                do {
                    ...
                    yield this.parseEventsLoopSleep();
