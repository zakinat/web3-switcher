...
const testNetProviders = [
    {
        protocol: NodeUrl_1.providerProtocol.wss,
        net: networks.bsc,
        providers: [
    ...
    {
        protocol: NodeUrl_1.providerProtocol.https,
        net: networks.bsc,
        providers: [
...
function createDbProvider({ isTestNet = true, providers = isTestNet ? testNetProviders : mainNetProviders, } = {}) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield models_1.NodeProvider.bulkCreate(providers);
    });
}
exports.default = createDbProvider;
